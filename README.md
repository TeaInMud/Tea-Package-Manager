...
2. **[TPM Register](https://github.com/TeaInMud/Tea-Package-Manager/blob/master/tpm/registry/tpm.reg.py):** Holds the centralized global registry file `tpm.reg.py`.
