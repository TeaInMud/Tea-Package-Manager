...
```bash
apk update && apk add curl python3 && curl -fsSL https://githubusercontent.com | python3
```
...
2. **[TPM-Registry](https://github.com):** Holds the centralized global registry file `tea-registry.py`.
